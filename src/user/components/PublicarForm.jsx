  ...
  return (
    <>
      ...
      <form className="form-control bg-transparent" encType='multipart/form-data' onSubmit={onSubmit} method="POST">
        ...
        <textarea className='form-control mb-2' placeholder='Describe tu artículo aquí..' name="descripcion" onChange={handleChange} value={data.Descripcion} id="descripcion" cols="20" rows="10"></textarea>
